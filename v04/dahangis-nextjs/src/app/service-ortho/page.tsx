    ...
    <div className="container py-5">
      ...
      <div className="row align-items-center g-5">
        <div className="col-md-6">
          <Image src="/images/gis_ortho_01.jpg" width={700} height={500} alt="정밀 정사영상 예시" className="img-fluid rounded shadow" />
        </div>
        <div className="col-md-6">
          <h2 className="h4 mb-3">서비스 소개</h2>
          <p>다한지리정보(주)는 최첨단 기술을 활용하여 고품질의 정밀 정사영상을 제작합니다. 항공 사진, 드론 촬영 등 다양한 방법으로 데이터를 수집하고, 전문적인 기술력을 바탕으로 오차를 최소화하여 정확한 지리 정보를 제공합니다.</p>
      ...
      <section className="mt-5">
        ...
        <div className="row g-4 justify-content-center"> {/* justify-content-center 추가 */}
          <div className="col-md-6 text-center"> {/* text-center 추가 */}
            <h5>주요 활용 기술</h5>
            <ul className="text-start"> {/* 리스트 항목은 왼쪽 정렬 유지 */}
              <li><strong>고정밀 항공삼각측량(AT):</strong> 다중 영상 기하 보정 및 번들 조정(Bundle Adjustment) 기술</li>
              <li><strong>정밀 DEM/DSM/DTM 생성:</strong> 스테레오 매칭, LiDAR 데이터 융합 기술</li>
              <li><strong>자동화된 정사보정 알고리즘:</strong> 자체 개발 또는 상용 S/W(예: Trimble Inpho, Agisoft Metashape) 활용</li>
              <li><strong>심리스 모자이크 및 색상 균일화:</strong> 방사 보정 및 최적 솔기선 탐색 기술</li>
              <li><strong>AI 기반 객체 탐지 및 분류:</strong> (선택 사항) 영상 내 특정 객체 자동 인식 기술</li>
            </ul>
          </div>
          <div className="col-md-6 text-center"> {/* text-center 추가 */}
      ...
      <section className="mt-5 py-5">
        <div className="container">
          ...
          <p className="text-center mb-4">다한지리정보는 국토교통부 공공측량 작업규정 및 고객 요구사항을 준수하여 최고 품질의 정사영상을 제공합니다.</p>
          <div className="row justify-content-center">
            <div className="col-md-8">
              ...
              <p className="small text-muted text-center">※ 상기 기준은 일반적인 예시이며, 프로젝트별 요구사항에 따라 달라질 수 있습니다.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="row g-4">
          <div className="col-md-4">
            <div className="card h-100 shadow-sm">
              <Image src="/images/ortho_use_case_1_placeholder.jpg" width={500} height={300} className="card-img-top" alt="도시 계획 활용" />
              <div className="card-body">
                <h5 className="card-title">국토 및 도시 계획</h5>
                <p className="card-text">도시 변화 모니터링, 토지 이용 계획 수립, 시설물 관리, 3D 도시 모델 구축 등</p>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="card h-100 shadow-sm">
               <Image src="/images/ortho_use_case_2_placeholder.jpg" width={500} height={300} className="card-img-top" alt="건설 및 토목 활용" />
              <div className="card-body">
                <h5 className="card-title">건설 및 토목</h5>
                <p className="card-text">공사 진척 관리, 토공량 산출, 구조물 안전 진단, 준공 도면 제작 등</p>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="card h-100 shadow-sm">
               <Image src="/images/ortho_use_case_3_placeholder.jpg" width={500} height={300} className="card-img-top" alt="환경 및 재난 관리 활용" />
              <div className="card-body">
                <h5 className="card-title">환경 및 재난 관리</h5>
                <p className="card-text">식생 변화 분석, 환경 오염 모니터링, 재해/재난 피해 지역 분석, 복구 계획 수립 등</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
            <div className="col">
              <div className="card h-100 shadow"> {/* shadow-sm -> shadow */}
                <Image src="/images/gis_data_01.jpg" width={500} height={300} className="card-img-top" alt="GIS 데이터 구축" />
            ...
            <div className="col">
              <div className="card h-100 shadow"> {/* shadow-sm -> shadow */}
                <Image src="/images/gis_consulting_01.jpg" width={500} height={300} className="card-img-top" alt="GIS 컨설팅" />
                <div className="card-body d-flex flex-column">
            ...
            <div className="col">
              <div className="card h-100 shadow"> {/* shadow-sm -> shadow */}
                <Image src="/images/gis_software_dev_01.jpg" width={500} height={300} className="card-img-top" alt="GIS 소프트웨어 개발" />
                <div className="card-body d-flex flex-column">
            ...
            <div className="col">
              <div className="card h-100 shadow"> {/* shadow-sm -> shadow */}
                <Image src="/images/gis_education_01.jpg" width={500} height={300} className="card-img-top" alt="GIS 교육" />
                <div className="card-body d-flex flex-column">
