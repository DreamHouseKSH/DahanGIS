  ...
  return (
    <> {/* Fragment 사용 */}
      <div className="main-content-area">
          ...
          <div className="container">
            ...
            <div className="row text-center g-4">
              <div className="col-md-4">
                ...
                <div className="shadow-sm rounded h-100"> {/* panel-bg-aliceblue 제거, bg-light 추가 */}
                  <div className="p-4"> {/* 내용 감싸는 div에 패딩 적용 */}
              ...
              <div className="col-md-4">
                 {/* Bootstrap 배경색 클래스 테스트 */}
                <div className="shadow-sm rounded h-100 bg-light"> {/* panel-bg-aliceblue 제거, bg-light 추가 */}
                  <div className="p-4"> {/* 내용 감싸는 div에 패딩 적용 */}
        ...
        {/* 서비스 카드 섹션 */}
        <section id="services-section" className="pb-5"> {/* 하단 패딩 추가 */}
          <div className="container">
