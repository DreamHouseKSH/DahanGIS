...
export default function V2ServicesPage() {
  return (
    <div className="v2-page">
      ...
      <section className="v2-section">
        <div className="v2-container">
          <h2 className="v2-section-title">서비스 프로세스</h2>
          <p className="v2-section-subtitle">체계적인 프로세스로 최고의 결과물을 제공합니다</p>

          <div className="v2-content-card">
            <div className="row text-center">
              <div className="col-md-3 mb-4 mb-md-0">
                <div className="v2-feature-icon mx-auto" style={{ background: 'var(--gradient-primary)' }}>
                  <i className="bi bi-chat-dots" />
                </div>
                <h4 className="v2-feature-title mt-3">1. 상담</h4>
                <p className="v2-feature-text">요구사항 파악 및 상담</p>
              </div>
              <div className="col-md-3 mb-4 mb-md-0">
                <div className="v2-feature-icon mx-auto" style={{ background: 'var(--gradient-accent)' }}>
                  <i className="bi bi-file-earmark-text" />
                </div>
                <h4 className="v2-feature-title mt-3">2. 기획</h4>
                <p className="v2-feature-text">분석 및 계획 수립</p>
              </div>
              <div className="col-md-3 mb-4 mb-md-0">
                <div className="v2-feature-icon mx-auto" style={{ background: 'var(--gradient-warm)' }}>
                  <i className="bi bi-gear" />
                </div>
                <h4 className="v2-feature-title mt-3">3. 수행</h4>
                <p className="v2-feature-text">프로젝트 실행</p>
              </div>
              <div className="col-md-3">
                <div className="v2-feature-icon mx-auto" style={{ background: 'linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)' }}>
                  <i className="bi bi-check-circle" />
                </div>
                <h4 className="v2-feature-title mt-3">4. 납품</h4>
                <p className="v2-feature-text">검수 및 최종 납품</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="v2-section">
        <div className="v2-container">
          <div className="v2-glass-card v2-glass-card-strong text-center" style={{ padding: '3rem 2rem' }}>
            <h3 className="v2-content-title">맞춤 서비스가 필요하신가요?</h3>
