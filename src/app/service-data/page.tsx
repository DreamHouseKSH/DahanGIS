    ...
    <div className="container py-5">
      ...
      <div className="row align-items-center g-5">
        ...
        <div className="col-md-6">
          ...
          <p>다한지리정보는 프로젝트 초기에 인터뷰와 현장 진단을 진행해 데이터 활용 목표와 업무 흐름을 구체화하고, 그 결과를 반영해 좌표계·속성 체계·품질 기준을 설계합니다.</p>
          <p>공공 및 민간 원천 데이터는 상호 검증 절차를 거치며 자동화 검사와 전문가 리뷰를 병행하여 좌표 보정, 위상 오류, 메타데이터 품질을 관리합니다.</p>
          <p>납품 단계에서는 표준 포맷 데이터와 품질 보고서, 운영 가이드를 함께 제공해 고객이 곧바로 업무에 활용할 수 있도록 돕습니다.</p>
