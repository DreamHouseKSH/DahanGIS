  ...
  return (
    <div className="container py-5">
      ...
      <p className="lead mb-5 text-center">
        전문가의 통찰력으로 최적의 GIS 활용 전략을 수립합니다.
      </p>
      ...
      <div className="row align-items-center g-5">
        ...
        <div className="col-md-6">
          ...
          <p>
            공간 정보 시스템 구축 및 운영에 대한 전문적인 컨설팅을 제공합니다. 고객 맞춤형 컨설팅,
            풍부한 경험과 노하우, 최적의 솔루션 제시를 통해 시스템 효율성을 향상시키고 투자 효과를
            극대화하며 경쟁력을 강화합니다.
          </p>
      ...
      <section className="mt-5 pt-5 border-top">
        ...
        <p className="text-center mb-4">
          다한지리정보는 고객의 성공적인 GIS 도입 및 활용을 위해 검증된 방법론과 체계적인 절차에
          따라 컨설팅을 수행합니다.
        </p>
          ...
          <div className="col-md-2">
            <div className="p-3 border rounded shadow-sm h-100">
              ...
              <p className="small mb-0">
                고객 비즈니스 환경, 기존 시스템, 데이터 현황 분석 및 명확한 목표 설정
              </p>
            </div>
          </div>
          <div className="col-md-2">
            <div className="p-3 border rounded shadow-sm h-100">
              ...
              <p className="small mb-0">
                최적의 GIS 도입/활용 전략, 기술 아키텍처, 단계별 실행 계획 수립
              </p>
            </div>
          </div>
          <div className="col-md-2">
            <div className="p-3 border rounded shadow-sm h-100">
              ...
              <p className="small mb-0">
                요구 기능 정의, 시스템 설계, 필요 기술 검토 및 PoC(개념 증명) 수행
              </p>
            </div>
          </div>
          <div className="col-md-2">
            <div className="p-3 border rounded shadow-sm h-100">
              ...
              <p className="small mb-0">
                솔루션 개발/구축 관리, 기존 시스템 연계, 데이터 마이그레이션 지원
              </p>
            </div>
          </div>
          <div className="col-md-2">
            <div className="p-3 border rounded shadow-sm h-100">
              ...
              <p className="small mb-0">
                도입 효과 분석, 사용자 교육, 시스템 안정화 및 운영 최적화 지원
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="mt-5">
        ...
        <p className="text-center mb-4">
          다한지리정보의 컨설턴트들은 풍부한 실무 경험과 깊이 있는 전문 지식을 바탕으로 고객에게
          최상의 가치를 제공합니다.
        </p>
        <div className="row g-4">
          <div className="col-md-4">
            <div className="text-center p-3 border rounded shadow-sm h-100">
              ...
              <h5>다년간의 실무 경험</h5>
              <p className="small">
                공공 및 민간 분야의 다양한 GIS 프로젝트 컨설팅 및 수행 경험 보유
              </p>
            </div>
          </div>
          <div className="col-md-4">
          ...
          <div className="col-md-4">
            <div className="text-center p-3 border rounded shadow-sm h-100">
              ...
              <h5>최신 기술 통찰력</h5>
              <p className="small">
                AI, 빅데이터, 클라우드 등 최신 IT 기술과 GIS 융합에 대한 깊은 이해
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div id="consultingCarousel" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
                ...
                <div className="card shadow-sm">
                  <div className="card-body">
                    <h5 className="card-title">
                      A 공공기관: 노후 시설물 관리 시스템 고도화 컨설팅
                    </h5>
                    <p className="card-text">
                      <strong>문제점:</strong> 분산된 데이터, 비효율적인 현장 점검 프로세스, 데이터
                      기반 의사결정 어려움
                    </p>
                    <p className="card-text">
                      <strong>컨설팅 내용:</strong> 통합 데이터베이스 모델 설계, 모바일 현장 점검
                      시스템 도입 방안 제시, GIS 기반 분석 및 시각화 기능 강화 전략 수립
                    </p>
                    <p className="card-text">
                      <strong>기대 효과:</strong> 업무 효율성 30% 향상, 데이터 정확도 개선, 예방적
                      유지보수 체계 구축
                    </p>
                  </div>
                </div>
              ...
              <div className="carousel-item">
                <div className="card shadow-sm">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      <strong>문제점:</strong> 주관적인 판단에 의존한 입지 선정, 높은 실패율, 경쟁사
                      분석 미흡
                    </p>
                    <p className="card-text">
                      <strong>컨설팅 내용:</strong> 상권 데이터, 유동 인구 데이터, 경쟁사 데이터 등
                      공간 빅데이터 분석 모델 구축, 최적 입지 추천 알고리즘 개발, GIS 기반 시각화
                      대시보드 제공
                    </p>
                    <p className="card-text">
                      <strong>기대 효과:</strong> 데이터 기반의 객관적인 입지 선정, 매장 오픈 성공률
                      증대, 경쟁 우위 확보
                    </p>
                  </div>
                </div>
              ...
              <div className="carousel-item">
                <div className="card shadow-sm">
                  <div className="card-body">
                    <h5 className="card-title">
                      C 에너지 기업: 신재생에너지 발전 최적 입지 분석 컨설팅
                    </h5>
                    <p className="card-text">
                      <strong>문제점:</strong> 방대한 후보지 탐색의 어려움, 복잡한 규제 및 환경 요인
                      고려 필요
                    </p>
                    <p className="card-text">
                      <strong>컨설팅 내용:</strong> 일사량, 풍속, 지형, 계통 연계, 환경 규제 등
                      다양한 공간 데이터를 중첩 분석하는 GIS 모델링 수행, 최적 후보지 도출 및 경제성
                      분석 지원
                    </p>
                    <p className="card-text">
                      <strong>기대 효과:</strong> 발전 효율 극대화, 사업 타당성 검토 시간 단축,
                      인허가 리스크 감소
                    </p>
                  </div>
                </div>
            ...
            <button
              ...
              type="button"
              data-bs-target="#consultingCarousel"
              data-bs-slide="prev"
            >
          ...
          <p className="small text-muted text-center mt-3">
            ※ 상기 사례는 이해를 돕기 위한 예시이며, 실제 컨설팅 내용과 다를 수 있습니다.
          </p>
        </div>
      </section>
      {/* // 성공적인 컨설팅 사례 끝 */}
