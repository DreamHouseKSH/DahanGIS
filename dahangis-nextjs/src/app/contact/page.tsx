    ...
    <>
        ...
        onLoad={() => {
          ...
          if (window.kakao && window.kakao.maps) {
            window.kakao.maps.load(() => {
              ...
              marker.setMap(map);
              const iwContent =
                '<div style="padding:5px; text-align:center;">다한지리정보(주)<br><a href="https://map.kakao.com/link/map/다한지리정보(주),37.66646028695495,126.7498890599695" style="color:blue" target="_blank">큰지도보기</a> <a href="https://map.kakao.com/link/to/다한지리정보(주),37.66646028695495,126.7498890599695" style="color:blue" target="_blank">길찾기</a></div>';
      ...
      <div className="container py-5">
        ...
        <p className="lead mb-5 text-center">
          다한지리정보(주)에 궁금한 점이 있으시면 언제든지 문의해주세요.
        </p>
          ...
          <div className="col-md-6">
            ...
            <ul className="list-unstyled mb-4">
              <li className="mb-3">
                ...
                <strong>주소:</strong> 경기도 고양시 일산서구 킨텍스로 240, GIFC 오피스 2211호
                (대화동, 킨텍스 꿈이그린)
              </li>
              <li className="mb-3">
          ...
          <div className="col-md-6">
            ...
            <form action="https://api.web3forms.com/submit" method="POST">
              ...
              <input
                type="hidden"
                name="redirect"
                value="https://www.dahangis.co.kr/contact"
              />{' '}
              {/* Next.js 경로로 수정 */}
              <div className="mb-3">
