    ...
    <div className="container py-5">
      ...
      <div className="row align-items-center g-5">
        ...
        <div className="col-md-6">
          ...
          <p>
            고객의 요구에 맞는 맞춤형 GIS 소프트웨어를 개발합니다. 최신 기술 적용, 사용자 친화적인
            인터페이스, 안정적인 시스템 운영을 통해 업무 효율성을 향상시키고 새로운 가치 창출 및
            경쟁 우위 확보를 지원합니다.
          </p>
      ...
      <section className="mt-5 pt-5 border-top">
        ...
        <p className="text-center mb-4">
          다한지리정보는 고객의 요구사항을 정확히 반영하고 고품질의 소프트웨어를 개발하기 위해
          표준화된 개발 프로세스를 따릅니다. (예: Agile, Waterfall 등 프로젝트 특성에 맞는 방법론
          적용)
        </p>
      ...
      <section className="mt-5">
        ...
        <p className="text-center mb-4">
          다한지리정보는 최신 기술 트렌드를 반영하여 안정적이고 확장 가능한 GIS 소프트웨어를
          개발합니다.
        </p>
        ...
        <p className="small text-muted text-center mt-3">
          ※ 프로젝트 요구사항 및 특성에 따라 최적의 기술 스택을 조합하여 사용합니다.
        </p>
      </section>
      {/* // 활용 기술 스택 끝 */}
          ...
          <div className="row g-4">
            <div className="col-md-6 col-lg-4">
              <div className="card h-100 shadow-sm">
                <Image
                  src="/images/portfolio_webgis_placeholder.jpg"
                  width={500}
                  height={300}
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    시설물 정보 조회, 편집, 공간 분석, 통계 리포팅 기능을 제공하는 웹 GIS 시스템.
                  </p>
                  <span className="badge bg-primary me-1">React</span>{' '}
                  <span className="badge bg-success me-1">Spring Boot</span>{' '}
                  <span className="badge bg-info me-1">PostGIS</span>{' '}
                  <span className="badge bg-warning text-dark">OpenLayers</span>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-4">
              <div className="card h-100 shadow-sm">
                <Image
                  src="/images/portfolio_mobile_placeholder.jpg"
                  width={500}
                  height={300}
                  className="card-img-top"
                  alt="모바일 GIS 앱"
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    스마트폰을 이용한 현장 데이터 수집, 사진 촬영, GPS 위치 기록, 오프라인 지도
                    지원.
                  </p>
                  <span className="badge bg-primary me-1">Flutter</span>{' '}
                  <span className="badge bg-success me-1">Node.js</span>{' '}
                  <span className="badge bg-info me-1">SQLite</span>{' '}
            ...
            <div className="col-md-6 col-lg-4">
              <div className="card h-100 shadow-sm">
                <Image
                  src="/images/portfolio_analysis_placeholder.jpg"
                  width={500}
                  height={300}
                  className="card-img-top"
                  alt="공간 분석 도구"
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    특정 산업 분야(예: 환경, 교통)를 위한 고급 공간 분석 및 시뮬레이션 기능 제공.
                  </p>
                  <span className="badge bg-primary me-1">Python</span>{' '}
                  <span className="badge bg-success me-1">Qt/PyQt</span>{' '}
                  <span className="badge bg-info me-1">GDAL</span>{' '}
                  <span className="badge bg-warning text-dark">QGIS Plugin</span>
                </div>
              </div>
            </div>
          </div>
          <p className="small text-muted text-center mt-3">
            ※ 상기 포트폴리오는 이해를 돕기 위한 예시입니다.
          </p>
        </div>
      </section>
      {/* // 개발 포트폴리오/사례 끝 */}
      ...
      <section className="mt-5">
        ...
        <div className="row align-items-center">
          <div className="col-md-7">
            <p>
              다한지리정보는 고객의 고유한 업무 환경과 요구사항에 완벽하게 부합하는 맞춤형 솔루션
              개발에 강점을 가지고 있습니다.
            </p>
            <ul>
              <li>
                <strong>기능 커스터마이징:</strong> 기존 GIS 솔루션에 특정 기능 추가 또는 수정
              </li>
              <li>
                <strong>UI/UX 맞춤 설계:</strong> 사용자 편의성을 고려한 인터페이스 맞춤 설계
              </li>
              <li>
                <strong>워크플로우 자동화:</strong> 반복적인 GIS 업무 자동화 기능 개발
              </li>
              <li>
                <strong>기존 시스템 연동:</strong> ERP, CRM, 그룹웨어 등 기간계 시스템과의 원활한
                데이터 연동 및 통합
              </li>
              <li>
                <strong>다양한 데이터 포맷 지원:</strong> 특수 데이터 포맷 입출력 기능 개발
              </li>
            </ul>
            <p>
              고객의 비즈니스 프로세스에 최적화된 유연하고 확장 가능한 시스템을 구축하여 투자 효과를
              극대화합니다.
            </p>
          </div>
          <div className="col-md-5">
            <Image
              src="/images/system_integration_placeholder.jpg"
              width={700}
              height={500}
              alt="시스템 통합 이미지"
              className="img-fluid rounded shadow"
      ...
      <section className="mt-5 py-5">
        <div className="container">
          ...
          <p className="text-center mb-4">
            소프트웨어 개발 완료 후에도 안정적인 시스템 운영과 지속적인 가치 창출을 위해 체계적인
            기술 지원 및 유지보수 서비스를 제공합니다.
          </p>
          <div className="row g-4">
            <div className="col-md-4">
              <div className="text-center p-3 h-100">
                ...
                <h5>기술 지원</h5>
                <p className="small">
                  시스템 운영 중 발생하는 기술 문의 응대, 원격 지원, 장애 처리
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="text-center p-3 h-100">
                ...
                <h5>업데이트 및 패치</h5>
                <p className="small">
                  기능 개선, 버그 수정, 보안 패치 등 정기/비정기 업데이트 제공
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="text-center p-3 h-100">
                ...
                <h5>성능 모니터링 및 최적화</h5>
                <p className="small">
                  시스템 성능 모니터링, 병목 현상 분석 및 개선, 데이터 백업/복구 지원
                </p>
              </div>
            </div>
          </div>
          <p className="text-center mt-4">
            고객과의 긴밀한 협력을 통해 시스템을 최적의 상태로 유지하고, 변화하는 비즈니스 환경에
            능동적으로 대응할 수 있도록 지원합니다. (별도 유지보수 계약 필요)
          </p>
        </div>
      </section>
      {/* // 기술 지원 및 유지보수 끝 */}
